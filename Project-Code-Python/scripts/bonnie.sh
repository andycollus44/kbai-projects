...
python submit.py --provider gt --assignment ${cmd} --files RavensProblemSolver.py RavensVisualProblem.py RavensTransformation.py RavensShape.py RavensSemanticSolver.py RavensSemanticRelationship.py shapes.txt
